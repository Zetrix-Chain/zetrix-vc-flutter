...
class VpRunnerWidget extends StatefulWidget {
  const VpRunnerWidget({super.key});

  @override
  State<VpRunnerWidget> createState() => _VpRunnerWidgetState();
}

class _VpRunnerWidgetState extends State<VpRunnerWidget> {
  String? result;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('VP Proof Generator')),
      body: Center(
        child: SingleChildScrollView(
          padding: const EdgeInsets.all(16),
          child: Text(result ?? 'Generating...'),
        ),
      ),
    );
  }
